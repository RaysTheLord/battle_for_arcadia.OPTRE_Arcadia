...
GRLIB_secondary_missions_costs = [15, 10, 8, 5, 3];                     // Intel price for the secondary missions [FOB hunting, Convoy ambush, SAR, HVT Kill, and VIP rescue].
...
GRLIB_surrender_chance = 0;                                             // Chance that enemy infantry will surrender after heavy losses are encountered.
...
KP_liberation_resistance_sector_chance = 33;                            // Chance that a guerilla squad will join an ongoing sector attack.
...
KPLIB_transportConfigs = [
	...
	["OPTRE_cart", 3, [0,0.75,1.75]],
	["OPTRE_forklift", 3, [0,0.75,1.75]],
	["OPTRE_M12_FAV", -3.75, [-.1,-1.25,0]],
	["OPTRE_M12_CIV", -3.75, [-.1,-1.25,0]],
	["OPTRE_M12_CIV2", -3.75, [-.1,-1.25,0]],
	["OPTRE_M12_FAV_ins", -3.75, [-.1,-1.25,0]],
	["OPTRE_M313_UNSC", -14, [0,5.6,-3.2], [-1.6,5.6,-3.2], [1.6,5.6,-3.2],[0,4,-3.2], [-1.6,4,-3.2], [1.6,4,-3.2], [0.7,-0.4,-3.2], [-0.7,-0.4,-3.2], [0.7,-2.1,-3.2], [-0.7,-2.1,-3.2], [0.7,-0.4,0.4], [-0.7,-0.4, 0.4], [0.7,-2.1,0.4], [-0.7,-2.1,0.4], [0.7,-3.8,-3.2], [-0.7,-3.8,-3.2], [0.7,-5.4,-3.2], [-0.7,-5.4,-3.2], [0.7,-7,-3.2], [-0.7,-7,-3.2]],
	["OPTRE_Pelican_unarmed", -7.5, [0,5.2,-2.3], [0,3.8,-2.3], [0,2.6,-2.3], [0,1.4,-2.3], [0,.2,-2.3], [0,-2.9,0], [0,-4.4,0],  [0,-5.9,0]],
	["OPTRE_Pelican_armed", -7.5, [0,5.2,-2.3], [0,3.8,-2.3], [0,2.6,-2.3], [0,1.4,-2.3], [0,.2,-2.3], [0,-2.9,0], [0,-4.4,0],  [0,-5.9,0]],
	["OPTRE_FC_Spirit", -7.5, [0,5.2,-2.3], [0,3.8,-2.3], [0,2.6,-2.3], [0,1.4,-2.3], [0,.2,-2.3], [0,-2.9,0], [0,-4.4,0],  [0,-5.9,0]],
	["OPTRE_m1015_mule_ins", -6.5, [0,0.3,0.05], [0,-1.3,0.05], [0,-2.9,0.05]],
	["OPTRE_FC_Spectre_Empty", -3.75, [-.1,-1.25,0]],
