...
hvt_kill = compileFinal preprocessFileLineNumbers "scripts\server\secondary\hvt_kill.sqf";
vip_rescue = compileFinal preprocessFileLineNumbers "scripts\server\secondary\vip_rescue.sqf";
