...
private _objects_to_build = [
    [ "OPTRE_FC_Energy_shield", [-0.11, 4.98, 0], 270.45 ],
    [ "OPTRE_FC_Barricade", [-3.24, 5.12, 0], 90.35 ],
    [ "OPTRE_FC_Barricade", [3.27, 5.52, 0], 90.35 ],
    [ "OPTRE_FC_Barricade", [8.17, 5.21, 0], 181.2 ],
    [ "OPTRE_FC_Barricade", [-8.76, 5.21, 0], 0.69 ],
    [ "Land_JumpTarget_F", [-0.84, -11.68, 0], 270.25 ],
    [ "OPTRE_FC_Watchtower", [15.5, -0.02, 0], 178.97 ],
    [ "OPTRE_FC_Watchtower", [-17.12, -0.35, 0], 179.97 ],
    [ "OPTRE_FC_Barricade", [16.94, 5.18, 0], 181.2 ],
    [ "Land_Cargo_House_V3_F", [-16.03, -9.69, 0], 269.88 ],
    [ opfor_transport_truck, [-10.4, 14.9, -0.02], 181.03 ],
    [ "OPTRE_FC_Barricade", [-17.6, 5.28, 0], 359.67 ],
    [ "Land_Cargo_HQ_V3_F", [11.25, 14.59, 0], 89.97 ],
    [ "OPTRE_FC_Barricade", [20.42, 1.73, 0], 89.37 ],
    [ "OPTRE_FC_Barricade", [-1.65, -21.15, 0], 0.36 ],
    [ opfor_flag, [-20.59, 7.5, 0], 90 ],
    [ "OPTRE_FC_Barricade", [21.02, -7.36, 0], 90.4 ],
    [ "OPTRE_FC_Barricade", [7.21, -21.33, 0], 1.39 ],
    [ "OPTRE_FC_Barricade", [-22.71, 1.71, 0], 91.24 ],
    [ opfor_mrap_armed, [-17.33, 14.88, 0.01], 359.22 ],
    [ "OPTRE_FC_Barricade", [20.76, 10.25, 0], 89.37 ],
    [ "OPTRE_FC_Barricade", [-10.52, -21.21, 0], 0.36 ],
    [ "OPTRE_FC_Barricade", [-22.91, -6.7, 0], 270.29 ],
    [ "OPTRE_FC_Barricade", [-23.19, 10.11, 0], 89.68 ],
    [ "OPTRE_FC_Barricade", [21.1, -16.14, 0], 90.4 ],
    [ "OPTRE_FC_Barricade", [15.97, -21.41, 0], 1.39 ],
    [ opfor_flag, [18.67, -19.05, 0], 90 ],
    [ opfor_mrap, [11.09, 25.14, 0.01], 268.69 ],
    [ opfor_flag, [-20.66, -18.6, 0], 90 ],
    [ "OPTRE_FC_Barricade", [-23.05, -15.49, 0], 271.36 ],
    [ "OPTRE_FC_Barricade", [20.55, 19.13, 0], 89.37 ],
    [ "OPTRE_FC_Barricade", [-19.29, -21.29, 0], 0.36 ],
    [ "OPTRE_FC_Barricade", [-23.27, 18.53, 0], 89.68 ]
];
