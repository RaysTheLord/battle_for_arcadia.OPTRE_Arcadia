private _objects_to_build = [
    ["OPTRE_FC_Barricade",[-15,-8,0],90],
    ["OPTRE_FC_Barricade",[-15,-16.5,0],90],
    ["OPTRE_FC_Barricade",[-15,-25,0],90],
    ["OPTRE_FC_Barricade",[-15,8,0],90],
    ["OPTRE_FC_Barricade",[-15,16.5,0],90],
    ["OPTRE_FC_Barricade",[-15,25,0],90],
    ["OPTRE_FC_Barricade",[15,-8,0],90],
    ...
    ["OPTRE_FC_Barricade",[15,16.5,0],90],
    ["OPTRE_FC_Barricade",[15,25,0],90],
    ["OPTRE_FC_Barricade",[11,30,0],0],
    ["OPTRE_FC_Barricade",[4,30,0],0],
    ["OPTRE_FC_Barricade",[-4,30,0],0],
    ["OPTRE_FC_Barricade",[-11,30,0],0],
    ["OPTRE_FC_Barricade",[11,-30,0],0],
    ["OPTRE_FC_Barricade",[4,-30,0],0],
    ["OPTRE_FC_Barricade",[-4,-30,0],0],
    ["OPTRE_FC_Barricade",[-11,-30,0],0],
    ["OPTRE_FC_Watchtower",[-10,-26,0],0],
    ["Land_Cargo_HQ_V3_F",[4,-20,0],0],
    ["Land_Cargo_House_V3_F",[-9,24,0],0],
    ["Land_Cargo_House_V3_F",[-1,24,0],0],
    ["OPTRE_FC_Watchtower",[10,24,0],180],
    ["OPTRE_FC_Barricade",[-21,-5,0],180],
    ["OPTRE_FC_Barricade",[-21,5,0],180],
    ["OPTRE_FC_Barricade",[21,-5,0],180],
    ["OPTRE_FC_Barricade",[21,5,0],180],
    ["OPTRE_FC_Cov_Deployable_Shield",[-22,-7,0],180],
    ["OPTRE_FC_Cov_Deployable_Shield",[-22,7,0],180],
    ["OPTRE_FC_Cov_Deployable_Shield",[19,-7,0],180],
    ["OPTRE_FC_Cov_Deployable_Shield",[19,7,0],180],
