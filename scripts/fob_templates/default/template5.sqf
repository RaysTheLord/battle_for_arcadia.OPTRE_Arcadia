private _objects_to_build = [
    [ "Land_JumpTarget_F", [-1.31, 11.44, 0], 0 ],
    [ opfor_transport_helo, [-1.31, 11.45, 0], 134.19 ],
    [ "OPTRE_FC_Watchtower", [17.36, 1.08, 0], 269.81 ],
    ...
    [ "COV_Supply_Pod_OPEN", [12.36, -16.46, 0], 228.14 ],
    [ opfor_flag, [20.06, 6.22, 0], 90 ],
    [ "COV_Supply_Pod_OPEN", [14.86, -16.08, 0], 2.94 ],
    [ "COV_Supply_Pod_CLOSED", [13.68, -18.27, 0], 287.62 ],
    [ "OPTRE_FC_Barricade", [-22.99, -3.72, 0], 89.34 ],
    [ "OPTRE_FC_Barricade", [22.88, 3.58, 0], 89.34 ],
    [ opfor_mrap, [17.18, 16.24, 0.01], 326.13 ],
    [ "OPTRE_FC_Barricade", [23.08, -5.21, 0], 89.34 ],
    [ "OPTRE_FC_Barricade", [0.66, -24.24, 0], 0.36 ],
    [ "OPTRE_FC_Barricade", [-8.2, -24.3, 0], 0.36 ],
    [ "OPTRE_FC_Barricade", [-22.79, -12.51, 0], 89.34 ],
    [ "OPTRE_FC_Barricade", [9.52, -24.42, 0], 1.39 ],
    [ "OPTRE_FC_Barricade", [23.35, -14.06, 0], 89.34 ],
    [ opfor_flag, [19.21, -21.72, 0], 90 ],
    [ "OPTRE_FC_Barricade", [-16.97, -24.38, 0], 0.36 ],
    [ "OPTRE_FC_Barricade", [18.28, -24.49, 0], 1.39 ],
    [ "OPTRE_FC_Barricade", [-22.52, -21.36, 0], 89.34 ],
    [ "OPTRE_FC_Barricade", [22.45, -21.48, 0], 103.04 ]
];
