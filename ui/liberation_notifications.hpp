class CfgNotifications {
    ...
    class lib_intel_hvt: lib_intel {
        description = $STR_NOTIFICATION_HVT_KILL_TEXT;
    };
    
    class lib_intel_vip: lib_intel {
        description = $STR_NOTIFICATION_VIP_RESCUE_TEXT;
    };
    ...
    class lib_secondary_hvt_complete: lib_default_notification {
        title = $STR_NOTIFICATION_SECONDARY_TITLE;
        description = $STR_NOTIFICATION_HVT_KILL_COMPLETE_TEXT;
        iconPicture = "res\notif\ui_notif_sob.paa";
        color[] = { 0, 1, 0, 1 };
        sound = "taskSucceeded";
    };
    
    class lib_secondary_vip_complete: lib_secondary_fob_destroyed {
        description = $STR_NOTIFICATION_VIP_RESCUE_COMPLETE_TEXT;
    };
    
    class lib_secondary_vip_failed: lib_secondary_fob_destroyed {
        description = $STR_NOTIFICATION_VIP_RESCUE_FAILED_TEXT;
        color[] = { 1, 0, 0, 1 };
        sound = "taskFailed";
    };
